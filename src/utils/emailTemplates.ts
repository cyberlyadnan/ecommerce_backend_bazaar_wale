 ...
 */
export const generateCustomerOrderEmail = (order: any, customerName: string): string => {
 ...
 */
export const generateVendorOrderEmail = (order: any, vendorName: string, vendorItems: any[]): string => {
  const formatCurrency = (amount: number) => {
    return new Intl.NumberFormat('en-IN', {
      style: 'currency',
      currency: 'INR',
